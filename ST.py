...
class SparseTransformer(nn.Module):
    def __init__(self, X_cross, D, F, M, st_model_path, lambda_l1=1, device='cuda'):
    ...
    def loss_j(self, x, x_hat, f):
        ...
        L1_pen = self.lambda_l1 * torch.sum(f * torch.norm(self.W_v.weight, p=2, dim=0), dim=1)
