...
models = ["intfloat/e5-large-v2", "Alibaba-NLP/gte-large-en-v1.5", 'whaleloops/phrase-bert', "paraphrase-MiniLM-L6-v2", "all-mpnet-base-v2"]
...
model_dict = run_all(datasets, models, n, graph=True, batch_size=16, iterations=1)